...
void MainMenu::start() {
    ...
    background.loadFromFile("imgMenu/menu_bg.png");
    txtBtNewGame.loadFromFile("imgMenu/btNewGame.png");
    txtBtContinue.loadFromFile("imgMenu/btContinue.png");
    txtBtSetup.loadFromFile("imgMenu/btSetup.png");
